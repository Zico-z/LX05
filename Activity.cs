    ...
    public class Activity {
        ...
        public IEnumerable<Model.Activity> GetNew()
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
                ...
                string sql = "select * from activity where activityVerift='审核通过'  and endTime>=now() order by endTime desc limit 2";
        ...
        public int Upadate(Model.Activity active)
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
        ...
        public int UpadateImg(Model.Activity active)
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
        ...
        public int UpadateVerify(Model.Activity active)
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
        ...
        public int UpadateRecommend(Model.Activity activity)
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
